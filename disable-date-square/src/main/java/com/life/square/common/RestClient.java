...
//            HotelDoc hotelDoc = new HotelDoc(hotel);
    ...
    //match查询
    public void matchQuery(String index,String name,String text) throws IOException {
...
//    getAllByISSPG(index,sortName,page,size,sortOrder,esName,diaryId);
...
//    public SearchHit[] searchByCondition(){
//
//    }
...
//        System.out.println(response);
    ...
    public SearchHit[] getDetailByMatchKeyWords(String index, Set<String> keywords, List<String> esName,Integer max) {
        try {
            //1.准备Request
            SearchRequest request = new SearchRequest(index);
